 ...
 */
class Version20180111043840 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE INDEX number_index ON transaction (transaction_number)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX number_index ON transaction');
