 ...
 */
final class Version20181025030629 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE customer DROP customer_phone_number, CHANGE customer_tags customer_tags JSON DEFAULT \'\' NOT NULL COMMENT \'(DC2Type:json)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE currency_rate CHANGE currency_rate_is_latest currency_rate_is_latest TINYINT(1) DEFAULT \'1\' NOT NULL');
        $this->addSql('ALTER TABLE customer ADD customer_phone_number VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, CHANGE customer_tags customer_tags JSON DEFAULT \'null\' NOT NULL COMMENT \'(DC2Type:json)\'');
