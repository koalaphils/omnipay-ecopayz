...
(1,	'4bisobliwqgw0w08s0kw0swog8w4co4os0kk04cw8s08000scs',	'a:0:{}',	'2wfdnjv550isosc0ksscwg8o0gcgg8kkcg40go8g044so0sk0o',	'a:2:{i:0;s:8:\"password\";i:1;s:13:\"refresh-token\";}');

INSERT INTO `oauth2_refresh_token` (`id`, `client_id`, `user_id`, `token`, `expires_at`, `scope`) VALUES
(1,	1,	1,	'YTg0MmRlODdmNzc0ZmVmOWZlYmRkMTg5YWU3NWE3ZGRiYzRhNGYzYjcwMWI3YzFiODYwMGRmYmI5YWE1ZDY0ZA',	1554986786,	'api');