 ...
 */
final class Version20181029025649 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_81398E093B6FAA7E ON customer');
        $this->addSql('ALTER TABLE customer DROP customer_currency_id, CHANGE customer_tags customer_tags JSON DEFAULT \'\' NOT NULL COMMENT \'(DC2Type:json)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE currency_rate CHANGE currency_rate_is_latest currency_rate_is_latest TINYINT(1) DEFAULT \'1\' NOT NULL');
        $this->addSql('ALTER TABLE customer ADD customer_currency_id INT UNSIGNED DEFAULT NULL, CHANGE customer_tags customer_tags JSON DEFAULT \'null\' NOT NULL COMMENT \'(DC2Type:json)\'');
        ...
        $this->addSql('CREATE INDEX IDX_81398E093B6FAA7E ON customer (customer_currency_id)');
        ...
        $this->addSql('ALTER TABLE transaction CHANGE transaction_updated_at transaction_updated_at DATETIME DEFAULT NULL, CHANGE transaction_to_customer transaction_to_customer BIGINT DEFAULT NULL, CHANGE dwl_id dwl_id BIGINT DEFAULT NULL, CHANGE transaction_bet_id transaction_bet_id BIGINT DEFAULT NULL, CHANGE transaction_bet_event_id transaction_bet_event_id BIGINT DEFAULT NULL, CHANGE transaction_commission_computed_original transaction_commission_computed_original NUMERIC(65, 10) DEFAULT NULL');
    }
}
