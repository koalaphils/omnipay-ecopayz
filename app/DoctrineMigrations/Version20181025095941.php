 ...
 */
final class Version20181025095941 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE user_phone_number user_phone_number VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE user_phone_number user_phone_number VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci');
    }
}
