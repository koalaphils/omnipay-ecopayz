 ...
 */
final class Version20181029025941 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE customer ADD customer_currency_id INT UNSIGNED DEFAULT NULL, CHANGE customer_tags customer_tags JSON DEFAULT \'\' NOT NULL COMMENT \'(DC2Type:json)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE customer DROP customer_currency_id, CHANGE customer_tags customer_tags JSON DEFAULT \'null\' NOT NULL COMMENT \'(DC2Type:json)\'');
