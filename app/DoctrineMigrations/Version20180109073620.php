 ...
 */
class Version20180109073620 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE INDEX status_index ON dwl (dwl_status)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX status_index ON dwl');
