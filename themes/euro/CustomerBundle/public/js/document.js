(function($, window, document, undefined){
    ...
    File.prototype = {
        ...
        _loadTemplate: function() {
            ...
            temp.find('.document-title').html('<i class="' + this.getIcon().icon + '"></i>&nbsp;&nbsp;'+this.fileInfo.title);
            temp.attr('id', 'document_' + this.index);
    ...
    $.fn[pluginName].defaults = {
        'file': {
            'template': {
                'main': '<div class="document-file"><div class="icon-container"></div><div class="document-info"><div class="document-title ellipsis" data-info="title"></div></div></div>',
                'icon': '<i class="icon"></i>',
                'img': '<div><img src=""/></div>'
            },
            autoRender: true
