...
class CustomerPaymentOptions
{
        ...
        array $options = [])
    {
        ...
        if (count($activeCpoFields) > 0 && isset($options['replace']) && $options['replace'] === true) {
            return $this->replaceFields($activeCpoFields, $paymentOptionCode, $transactionType, $determinantField, $values[$determinantField]);
        }
    ...
    public function replaceFields($activeCpoFields, $paymentOptionCode, $transactionType, $determinantField, $value)
    {
        ...
        $newFields[$determinantField] = $value;
